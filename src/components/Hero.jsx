        ...
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <div className={`flex flex-row justify-between items-center w-full`}>
                ...
                >
                    ...
                    <span
                    className="text-gradient">Generration
                    </span> {"  "}
                </h1>
                <div className={`ss:flex hidden mg:mr-4 mr-0`}>
                    <GetStarted />
                </div>
            </div>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5 `}>
                ...
                Temporibus ducimus alias itaque reiciendis adipisci voluptatum, 
                accusantium dolores ea cupiditate veniam?
            </p>
        </div>
